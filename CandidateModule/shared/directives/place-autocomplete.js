...
(function () {
  ...
  **/
  ...
  angular.module("CandidateOnBoarding").directive('ngAutocomplete', ['$timeout', '$filter', function($timeout, $filter) {
    return {
        require: 'ngModel',
        replace: true,
        scope: {
                ...
                if (result !== undefined) {
                    if (result.address_components !== undefined) {
                        $timeout(function() {
                            ...
                            var addrSet = getFieldMaskSetting('Autocomplete the field with', scope.currentfield);
                            var addrType = addrSet.value;
                            var resSet = getFieldMaskSetting('Autofill other fields', scope.currentfield);
                            if (addrType == 'full-address') {
  ...
  // angular.module("CandidateOnBoarding").directive('ngAutocomplete', ['$timeout', function ($timeout) {
  //   return {
  //     require: 'ngModel',
  //     replace:true,
  //     scope: {
