(function() {
    ...
    // candidateApp.directive('convertStarsDynamic', ['$parse', function($parse) {
    //     // require: "ngModel",
    //     return {
    //         restrict: 'A',
    //         scope: {
    ...
    //                 scope.newmodel = scope.newmodel ? scope.newmodel : finalssnval;
    //                 tempVal = '';
    ...
    //                         var matched = false;
    //                         if(scope.patternmodel == 'numericwithdecimal'){
    ...
    //     };
    // }]);
    candidateApp.directive('eDirective', function() {
        return {
          restrict: 'A',
          scope: {
            config: '='
    ...
    candidateApp.directive('mappingValueChangeCheck', function() {
        return {
          restrict: 'A',
          //require: 'convertStarsDynamic',
          link: function(scope, element, attrs,ctrl) {
              scope.$watch(attrs['ngModel'], function (newvalue, oldvalue) {
                if(newvalue != oldvalue && attrs['mappingid'] != '0'){
                    scope.$parent.$parent.field.isUpdated = true;
                }
              });
          }
    ...
    candidateApp.directive('aDirective123', function() {
            return {
                restrict: 'A',
                require: 'convertStarsDynamic',
                scope: {
    ...
    candidateApp.directive('dateValidation', function() {
        return {
            link: function(scope, element, attributes, ngModel) {
    ...
    var othermodelnum = 1;
    candidateApp.directive('convertStarsDynamic', ['$parse','$filter', function($parse, $filter) {
        return {
            require: "ngModel",
            scope: {
                bindedModel: "=ngModel",
    ...
    //     };
    // }]);
    candidateApp.directive('dynamicValidation', ['$parse', function($parse) {
        return {
            require: "ngModel",
            scope: {
                bindedModel: "=ngModel",
    ...
    candidateApp.directive('dynamicDateValidation', ['$parse', function($parse) {
        return {
            require: "ngModel",
            link: function(scope, element, attributes, ngModel) {
