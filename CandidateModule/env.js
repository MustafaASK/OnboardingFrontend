(function (window) {
    ...
    // window.__env.FrontEndURL = 'http://192.168.1.39:3000/#/'; //for forgot password email
    // window.__env.FrontEndURLForCandidate = 'http://192.168.1.39:3000/#/candidate/reset/'; //for forgot password email of candidate
    // window.__env.FrontEndURLForCandidateLogin = 'http://192.168.1.39:3000/#/candidate/login';
    ...
    // window.__env.baseUrl = '/';
    // window.__env.rootUrl = '/onboarding-performance';
    // window.__env.enableDebug = false;
    // window.__env.idleTime = 2 * 60 * 60;

    // **  Production Environment **
    // window.__env.apiServerIp = 'onboard.askstaffing.com';
    // window.__env.fileServerIp = 'onboard.askstaffing.com';
    // window.__env.CandidateAPIURL = 'https://onboard.askstaffing.com/onboarding_cob/';
    // window.__env.CandidateDocsURL = 'https://onboard.askstaffing.com/onboarding_docs/Candidatedocs/';
    // window.__env.SignedOfferLetterURL = 'https://onboard.askstaffing.com/onboarding_docs/Echosign/';
    // window.__env.offerLetterPreview = 'https://onboard.askstaffing.com/onboarding_docs/tempDelete/';
    // window.__env.APIURL = 'https://' + window.__env.apiServerIp + '/onboarding_admin/';
    // window.__env.UploadsURL = 'https://' + window.__env.fileServerIp;
    // window.__env.DocsURL = 'https://' + window.__env.fileServerIp + '/onboarding_docs/Docs/';
    // window.__env.NewHireDocsURL = 'https://' + window.__env.fileServerIp + '/onboarding_docs/NewHire/';
    // window.__env.SignImageURL = 'https://' + window.__env.fileServerIp + '/onboarding_docs/Signatures/signature_logo.png';
    // window.__env.EchoDocsURL = 'https://' + window.__env.fileServerIp + '/onboarding_docs/Echosign/';
    // window.__env.ProfilePicURL = 'https://' + window.__env.fileServerIp + '/onboarding_docs/Profilepic/';
    // window.__env.ImagesURL = 'https://' + window.__env.fileServerIp + '/onboarding_docs/Introduction/';
    // window.__env.LogoURL = 'https://' + window.__env.fileServerIp + '/onboarding_docs/Branding/logo/logo_image.';
    // window.__env.BackgroundURL = 'https://' + window.__env.fileServerIp + '/onboarding_docs/Branding/bgimg/bg_image.';
    // window.__env.FrontEndURL = 'https://hruser.askstaffing.com/hruser/#/'; //for forgot password email
    ...
    __env.errorMsgs = {
        ...
        "MSG125": "Email Template cannot be more than 1,000 characters length.",
        ...
        "MSG269": "Maximum file size should be 20MB",
        "MSG270": "Please fill required BGV forms"
